        ...
        <div className="mx-auto w-full max-w-7xl px-4">
          <div className="flex h-16 items-center justify-between gap-3 md:h-20">
            <div className="flex items-center gap-2 md:gap-4">
              <button
                type="button"
                className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-gray-200 text-gray-700 transition hover:bg-gray-50 md:hidden"
                onClick={() => {
              ...
              <Link href="/" className="whitespace-nowrap text-lg font-bold tracking-tight text-primary sm:text-xl md:text-2xl">
                Aki-Oka
              </Link>
            </div>
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <Link
                href="/wishlist"
                className="hidden h-10 w-10 items-center justify-center rounded-xl border border-gray-200 text-gray-700 transition hover:bg-gray-50 hover:text-primary md:inline-flex"
              ...
              <Link
                href="/cart"
                className="relative inline-flex h-10 w-10 items-center justify-center rounded-xl border border-gray-200 text-gray-700 transition hover:bg-gray-50 hover:text-primary"
                aria-label="Корзина"
              >
                <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {isAuthenticated ? (
                <div className="relative">
                  <button
                    ...
                    className="flex h-10 items-center gap-2 rounded-xl border border-gray-200 px-2.5 transition hover:bg-gray-50"
                  ...
                  {showUserMenu && (
                    <div
                      className="absolute right-0 mt-2 w-72 overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-xl"
                    ...
                    >
                      <div className="flex items-center gap-3 border-b border-gray-100 p-4">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="truncate font-semibold text-gray-900">{user?.first_name || user?.username}</p>
                ...
                <Link
                  href="/login"
                  className="inline-flex h-10 items-center gap-2 rounded-xl bg-primary px-3 text-sm font-medium text-white transition hover:bg-blue-600 md:px-4"
                >
                  <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>

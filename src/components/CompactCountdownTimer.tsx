  ...
  if (isExpired) {
    return (
      <div className="bg-white/20 rounded-lg px-4 py-2">
        <p className="text-white text-sm font-semibold">Акция завершена</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {timeLeft.days > 0 && (
        <>
          <div className="bg-white/20 backdrop-blur-sm rounded-lg px-3 py-2 min-w-[60px] text-center">
            ...
            <div className="text-xs text-white/80">дней</div>
          </div>
      ...
      <div className="bg-white/20 backdrop-blur-sm rounded-lg px-3 py-2 min-w-[60px] text-center">
        ...
        <div className="text-xs text-white/80">минут</div>
      </div>
      ...
      {/* Секунды */}
      <div className="bg-white/20 backdrop-blur-sm rounded-lg px-3 py-2 min-w-[60px] text-center">
        <div className="text-xl font-bold text-white animate-pulse">{String(timeLeft.seconds).padStart(2, '0')}</div>
        <div className="text-xs text-white/80">секунд</div>
      </div>
    </div>
  );
}
